module Dcrawler
  ...
  #
  def Dcrawler.crawl(options = {}, &block)
  ...
  class Core
    ...
    DEFAULT_OPTS = {
      ...
      # identify self as Dcrawler/VERSION
      :user_agent => "Dcrawler/#{Dcrawler::VERSION}",
    ...
    def run
      ...
      loop do
        ...
        if self.class.stop_crawler? || @crawl_page_count >= @opts[:page_crawl_limit]
          break
        end
